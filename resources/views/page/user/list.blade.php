            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('user.create') }}" class="btn btn-success mb-3">Tambah</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex gap-2">
                                        <a href="{{ route('user.edit',['user'=>$item->id]) }}" class="btn btn-warning"><i class="fa fa-edit"></i> Ubah</a>
