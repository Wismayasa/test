...
<div class="content-header">
    <div class="row mb-2 px-3 py-3">
        <div class="col-sm-6">
            <h2 class="fs-5">Data Barang Masuk</h2>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('barangmasuk.create') }}" class="btn btn-success mb-3">Tambah</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex gap-2">
                                        <a href="{{ route('barangmasuk.edit',['barangmasuk'=>$item->id]) }}" class="btn btn-warning"><i class="fa fa-edit"></i> Ubah</a>
                                        <form action="{{ route('barangmasuk.destroy',['barangmasuk'=>$item->id]) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
